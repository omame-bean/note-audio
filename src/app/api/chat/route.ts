...
動画生成:
生成されたノートから動画を作成できます。「動画タイプを選択」ドロップダウンメニューから、パソコン用（横向き）またはスマホ用（縦向き）の動画形式を選択できます。「動画を生成」ボタンをクリックすると、選択したタイプでノートの内容を基に動画が生成されます。生成には2～3分程度かかります。生成が完了すると、動画をダウンロードできます。
